      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="{{ url('admin/dashboard') }}" class="app-brand-link">
            ...
            <span style="text-transform:capitalize" class="app-brand-text demo menu-text fw-bolder ms-2">{{ $app_setting->website_name }}</span>
          </a>
              ...
              {{-- /USERS --}}
               ...
               <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  ...
                  <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="{{ url('admin/coupens') }}" class="menu-link">
                            <div>View Coupens</div>
                        </a>
                    </li>
                  </ul>
              </li>
