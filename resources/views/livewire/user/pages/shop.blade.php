            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div id="aside" class="col-md-3">
                       ...
                       @include('user_layout.pages.shop_filter.category_filter')
                        {{-- END --}}
                       ...
                       {{-- ADD BRANDS SECTION --}}
                       @include('user_layout.pages.shop_filter.brand_filter')
                        {{-- END --}}
                    ...
                    <div id="store" class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            @empty
                                <div class="col-md-12">
                                    {{-- <h2>No Products Found For {{ $products->category->name }}</h2> --}}
                                </div>
                            @endforelse
